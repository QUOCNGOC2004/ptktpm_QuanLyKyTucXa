...
CREATE TABLE Users (
    ...
    role ENUM('manager', 'student_manager', 'accountant') NOT NULL,
...
('admin2', 'adminpass2', 'Quản lí phòng'),
('manager2', 'managerpass2', 'Quản lí sinh viên'),
('account2', 'accountpass2', 'Kế toán'),
('admin3', 'adminpass3', 'Quản lí phòng'),
('manager3', 'managerpass3', 'Quản lí sinh viên');

-- Thêm dữ liệu mẫu vào bảng Rooms
INSERT INTO Rooms (building, room_code, floor, room_number, capacity, status, price) VALUES
-- Tòa nhà A
('A', 'A101', 1, '101', '2', 'maintenance', 2200000),
('A', 'A102', 1, '102', '2', 'occupied', 2200000),
('A', 'A103', 1, '103', '2', 'occupied', 2200000),
('A', 'A104', 1, '104', '2', 'occupied', 2200000),
('A', 'A105', 1, '105', '2', 'occupied', 2200000),
('A', 'A106', 1, '106', '2', 'available', 2200000),
('A', 'A107', 1, '107', '2', 'occupied', 2200000),
('A', 'A108', 1, '108', '2', 'available', 2200000),
('A', 'A109', 1, '109', '2', 'maintenance', 2200000),
('A', 'A110', 1, '110', '2', 'maintenance', 2200000),

('A', 'A201', 2, '201', '2', 'available', 2200000),
('A', 'A202', 2, '202', '2', 'available', 2200000),
('A', 'A203', 2, '203', '2', 'maintenance', 2200000),
('A', 'A204', 2, '204', '2', 'available', 2200000),
('A', 'A205', 2, '205', '2', 'available', 2200000),
('A', 'A206', 2, '206', '2', 'available', 2200000),
('A', 'A207', 2, '207', '2', 'available', 2200000),
('A', 'A208', 2, '208', '2', 'maintenance', 2200000),
('A', 'A209', 2, '209', '2', 'available', 2200000),
('A', 'A210', 2, '210', '2', 'available', 2200000),

('A', 'A301', 3, '301', '2', 'available', 2200000),
('A', 'A302', 3, '302', '2', 'available', 2200000),
('A', 'A303', 3, '303', '2', 'maintenance', 2200000),
('A', 'A304', 3, '304', '2', 'available', 2200000),
('A', 'A305', 3, '305', '2', 'available', 2200000),
('A', 'A306', 3, '306', '2', 'available', 2200000),
('A', 'A307', 3, '307', '2', 'maintenance', 2200000),
('A', 'A308', 3, '308', '2', 'available', 2200000),
('A', 'A309', 3, '309', '2', 'maintenance', 2200000),
('A', 'A310', 3, '310', '2', 'available', 2200000),
...
('SV20240001', 'Nguyen Van A', 'a@example.com', '0901234567', 'Male', '2001-02-15', '123 Nguyen Trai, District 1', 'Vietnam', 'Computer Science', 3, 3.5, (SELECT room_id FROM Rooms WHERE room_code = 'A102' AND building = 'A'), 'Active'),
('SV20240002', 'Tran Thi B', 'b@example.com', '0902345678', 'Female', '2000-07-20', '456 Le Loi, District 3', 'Vietnam', 'Business Administration', 4, 3.8, (SELECT room_id FROM Rooms WHERE room_code = 'A102' AND building = 'A'), 'Active'),

('SV20240003', 'Le Van C', 'c@example.com', '0903456789', 'Male', '2002-05-10', '789 Cach Mang Thang 8, District 10', 'Vietnam', 'Economics', 2, 3.2, (SELECT room_id FROM Rooms WHERE room_code = 'A103' AND building = 'A'), 'Active'),
('SV20240004', 'Pham Thi D', 'd@example.com', '0904567890', 'Female', '2001-11-30', '101 Vo Van Tan, District 1', 'Vietnam', 'Marketing', 5, 3.9, (SELECT room_id FROM Rooms WHERE room_code = 'A103' AND building = 'A'), 'Active'),

('SV20240005', 'Hoang Van E', 'e@example.com', '0905678901', 'Male', '2002-09-10', '102 Tran Hung Dao, District 5', 'Vietnam', 'Information Technology', 1, 3.0, (SELECT room_id FROM Rooms WHERE room_code = 'A104' AND building = 'A'), 'Active'),

('SV20240006', 'Do Thi F', 'f@example.com', '0906789012', 'Female', '2000-12-12', '15 Dien Bien Phu, District 3', 'Vietnam', 'Finance', 4, 3.6, (SELECT room_id FROM Rooms WHERE room_code = 'A105' AND building = 'A'), 'Active'),
('SV20240007', 'Vo Van G', 'g@example.com', '0907890123', 'Male', '2001-01-15', '20 Hai Ba Trung, District 5', 'Vietnam', 'Law', 3, 3.4, (SELECT room_id FROM Rooms WHERE room_code = 'A105' AND building = 'A'), 'Active'),

('SV20240008', 'Nguyen Thi H', 'h@example.com', '0908901234', 'Female', '2000-03-10', '30 Pham Ngu Lao, District 1', 'Vietnam', 'Engineering', 5, 3.7, (SELECT room_id FROM Rooms WHERE room_code = 'B202' AND building = 'B'), 'Active'),
('SV20240009', 'Tran Van I', 'i@example.com', '0909012345', 'Male', '1999-08-25', '35 Le Van Sy, District 3', 'Vietnam', 'Graphic Design', 4, 3.3, (SELECT room_id FROM Rooms WHERE room_code = 'B202' AND building = 'B'), 'Active'),
('SV20240010', 'Nguyen Van J', 'j@example.com', '0900123456', 'Male', '2001-05-20', '12 Bach Dang, District 10', 'Vietnam', 'Architecture', 2, 3.1, (SELECT room_id FROM Rooms WHERE room_code = 'B202' AND building = 'B'), 'Active'),

('SV20240011', 'Le Thi K', 'k@example.com', '0901234567', 'Female', '2000-10-15', '15 Nguyen Hue, District 1', 'Vietnam', 'Mechanical Engineering', 4, 3.5, (SELECT room_id FROM Rooms WHERE room_code = 'B205' AND building = 'B'), 'Active'),
('SV20240012', 'Hoang Van L', 'l@example.com', '0902345678', 'Male', '1998-09-22', '25 Dong Khoi, District 3', 'Vietnam', 'Civil Engineering', 5, 3.0, (SELECT room_id FROM Rooms WHERE room_code = 'B205' AND building = 'B'), 'Active'),

('SV20240013', 'Le Thi M', 'k@example.com', '0901234567', 'Female', '2000-10-15', '15 Nguyen Hue, District 1', 'Vietnam', 'Mechanical Engineering', 4, 3.5, (SELECT room_id FROM Rooms WHERE room_code = 'C302' AND building = 'C'), 'Active'),
('SV20240014', 'Hoang Van N', 'l@example.com', '0902345678', 'Male', '1998-09-22', '25 Dong Khoi, District 3', 'Vietnam', 'Civil Engineering', 5, 3.0, (SELECT room_id FROM Rooms WHERE room_code = 'C302' AND building = 'C'), 'Active'),
('SV20240015', 'Le Thi O', 'k@example.com', '0901234567', 'Female', '2000-10-15', '15 Nguyen Hue, District 1', 'Vietnam', 'Mechanical Engineering', 4, 3.5, (SELECT room_id FROM Rooms WHERE room_code = 'C302' AND building = 'C'), 'Active'),

('SV20240016', 'Hoang Van P', 'l@example.com', '0902345678', 'Male', '1998-09-22', '25 Dong Khoi, District 3', 'Vietnam', 'Civil Engineering', 5, 3.0, (SELECT room_id FROM Rooms WHERE room_code = 'C305' AND building = 'C'), 'Active'),
('SV20240017', 'Le Thi Q', 'k@example.com', '0901234567', 'Female', '2000-10-15', '15 Nguyen Hue, District 1', 'Vietnam', 'Mechanical Engineering', 4, 3.5, (SELECT room_id FROM Rooms WHERE room_code = 'C305' AND building = 'C'), 'Active'),
('SV20240018', 'Hoang Van Z', 'l@example.com', '0902345678', 'Male', '1998-09-22', '25 Dong Khoi, District 3', 'Vietnam', 'Civil Engineering', 5, 3.0, (SELECT room_id FROM Rooms WHERE room_code = 'C305' AND building = 'C'), 'Active'),
('SV20240019', 'Hoang Van X', 'l@example.com', '0902345678', 'Male', '1998-09-22', '25 Dong Khoi, District 3', 'Vietnam', 'Civil Engineering', 5, 3.0, (SELECT room_id FROM Rooms WHERE room_code = 'C305' AND building = 'C'), 'Active');
...
(1, 'HD20240001', 2, 100.50, 30.20, 1500000.00, 'paid', '2024-10-26 15:51:16'),
(2, 'HD20240002', 11, 120.30, 40.10, 1600000.00, 'unpaid', '2024-10-26 15:51:16'),
(3, 'HD20240003', 21, 95.80, 25.70, 1500000.00, 'paid', '2024-10-26 15:51:16'),
(4, 'HD20240004', 32, 110.20, 35.40, 1600000.00, 'paid', '2024-10-26 15:51:16'),
(5, 'HD20240005', 41, 130.50, 45.30, 1600000.00, 'unpaid', '2024-10-26 15:51:16'),
(6, 'HD20240006', 51, 140.70, 50.10, 1600000.00, 'paid', '2024-10-26 15:51:16'),
(7, 'HD20240007', 62, 90.40, 28.90, 1700000.00, 'paid', '2024-10-26 15:51:16'),
(8, 'HD20240008', 72, 85.60, 27.30, 1700000.00, 'unpaid', '2024-10-26 15:51:16'),
(9, 'HD20240009', 83, 75.30, 24.80, 1700000.00, 'paid', '2024-10-26 15:51:16'),
(10, 'HD20240010', 1, 200.00, 7.00, 2205000.00, 'unpaid', '2024-09-30 17:00:00'),
(11, 'HD20240011', 1, 100.00, 2.00, 1830000.00, 'unpaid', '2024-10-31 17:00:00'),
(12, 'HD20240012', 2, 234.00, 23.00, 3247000.00, 'unpaid', '2024-10-31 17:00:00'),
(13, 'HD20240013', 3, 134.00, 12.00, 2782000.00, 'unpaid', '2024-08-31 17:00:00'),
(14, 'HD20240015', 4, 234.00, 5.00, 2977000.00, 'unpaid', '2024-09-30 17:00:00'),
(15, 'HD20240016', 5, 123.00, 4.00, 2629000.00, 'unpaid', '2024-09-30 17:00:00'),
(16, 'HD20240017', 7, 342.00, 12.00, 3406000.00, 'unpaid', '2024-09-30 17:00:00'),
(17, 'HD20240018', 42, 123.00, 43.00, 2614000.00, 'unpaid', '2024-09-30 17:00:00'),
(18, 'HD20240019', 45, 123.00, 12.00, 2149000.00, 'unpaid', '2024-09-30 17:00:00'),
(19, 'HD20240020', 77, 453.00, 23.00, 3404000.00, 'unpaid', '2024-09-30 17:00:00'),
(20, 'HD20240021', 80, 234.00, 9.00, 2537000.00, 'unpaid', '2024-09-30 17:00:00'),
(21, 'HD20240022', 82, 214.00, 11.00, 2507000.00, 'unpaid', '2024-09-30 17:00:00'),
(22, 'HD20240023', 85, 435.00, 12.00, 3185000.00, 'unpaid', '2024-09-30 17:00:00');
...
((SELECT room_id FROM Rooms WHERE room_code = 'A201'), (SELECT student_id FROM Students WHERE student_code = 'SV20240002'), '2024-01-20', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'A301'), (SELECT student_id FROM Students WHERE student_code = 'SV20240003'), '2024-01-25', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'B102'), (SELECT student_id FROM Students WHERE student_code = 'SV20240004'), '2024-02-01', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'B201'), (SELECT student_id FROM Students WHERE student_code = 'SV20240005'), '2024-02-05', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'B301'), (SELECT student_id FROM Students WHERE student_code = 'SV20240006'), '2024-02-10', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'C102'), (SELECT student_id FROM Students WHERE student_code = 'SV20240007'), '2024-02-15', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'C202'), (SELECT student_id FROM Students WHERE student_code = 'SV20240008'), '2024-02-20', NULL),
((SELECT room_id FROM Rooms WHERE room_code = 'C303'), (SELECT student_id FROM Students WHERE student_code = 'SV20240009'), '2024-02-25', NULL);
